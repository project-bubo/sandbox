        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            updatePageStructure = function () {
                ...
                if (options.currentIndex == 0) {
                    $('.prev-page, .outer-arrow.prev').fadeOut(500);
                } else {
                    $('.prev-page, .outer-arrow.prev').fadeIn(500);
                };

                //hide last pager
                if (options.currentIndex == (options.pageTotal - 2) ) {
                    $('.next-page, .outer-arrow.next').fadeOut(500);
                } else {
                    $('.next-page, .outer-arrow.next').fadeIn(500);
                };
